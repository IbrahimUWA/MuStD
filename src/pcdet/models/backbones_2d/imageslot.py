...
class SoftPositionEmbed(nn.Module):
    ...
    def forward(self, inputs):
        print(self.proj(self.grid).shape,"prjected")
...
class SlotAttentionAutoEncoder(nn.Module):
    ...
    def __init__(self, resolution=(32,32), num_slots=20, in_out_channels=512, iters=5):
        ...
        self.encoder_arch = [256, 'MP', 512, 'MP', 512]
    ...
    def forward(self, image):
        ...
        # x = torch.bmm(x, slots.transpose(-1, -2))
        # x = torch.bmm(x.transpose(-1, -2), slots)
        # return x
        #
        # print( x.shape, " bmm")
        #
        ...
        # print(x.shape, "x decoder_pos")
        x = self.decoder_cnn(x)
        # print(x.shape, "x decoder")
