...
class KittiDatasetMM(DatasetTemplate):
    ...
    def __getitem__(self, index):
        ...
        img = self.get_image(image_idx)
        # print(img.shape, "img.shape")
        image = np.zeros((380,1250,3))
        image[0:img.shape[0],0:img.shape[1],0:3] = img[0:img.shape[0],0:img.shape[1],0:3]
        ...
        # print(points.shape, "FOVpoints.shape")
        ...
        # print((data_dict['image'].shape),"data_dict")
        return data_dict
